...
public class SharedPreferencesManager {
    ...
    public void saveBeerList(List<Root> books, String listKey) {
        Gson gson = new Gson();
    ...
    public List<Root> getBeerList(String listKey){
    ...
    public void saveFavoriteBeerList(List<Root> books, String listKey) {
        Gson gson = new Gson();
        //gson.tojson qui transforme la liste en chaine de caractere
        String booksAsString = gson.toJson(books);
        save(listKey,booksAsString);
    ...
    public List<Root> getFavoriteBeerList(String listKey){
        List<Root> booksList = new ArrayList<>();
        Gson gson = new Gson();
        Root[] books = gson.fromJson(get(listKey), Root[].class);
        if (books != null){
    ...
    public void addBeerToListFavorite(Root root,String listKey ){
        ArrayList<Root> books = new ArrayList<>(getBeerList(listKey));
        remove(listKey);
        books.add(root);
        saveFavoriteBeerList(books,listKey);
    }
